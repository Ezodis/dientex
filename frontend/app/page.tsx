...
export default function Home() {
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col">
      ...
      <header className="border-b bg-white/90 backdrop-blur-sm z-50 shrink-0">
      ...
      {/* ── Fullpage snap-scroll container ── */}
      <div className="flex-1 overflow-y-scroll snap-y snap-mandatory">

        {/* ── Slide 1: Hero + Dentists ── */}
        <section className="h-full snap-start bg-gradient-to-b from-blue-50 to-white overflow-y-auto flex flex-col">
          {/* Hero */}
        ...
        {/* ── Slide 2: Clinics Map (full viewport) ── */}
        <section ref={mapSectionRef} className="h-full snap-start bg-white flex flex-col">
          <div className="container mx-auto px-4 pt-6 pb-2 shrink-0 text-center">
            <h2 className="text-xl sm:text-2xl font-bold mb-1">Nuestros consultorios</h2>
            <p className="text-muted-foreground text-sm">
              Encuéntranos en las siguientes ubicaciones
            </p>
          </div>

          {/* Map expands to fill remaining height */}
          <div className="flex-1 min-h-0 overflow-hidden">
            <ClinicMapClient />
          </div>

          {/* ── Footer ── */}
          <footer className="border-t bg-white py-4 shrink-0">
            <div className="container mx-auto px-4">
              <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm text-muted-foreground mb-2">
